...
import { FBIcon, VKIcon, YTIcon } from "@/app/components/Icons";
		...
		<footer className="border-t border-gray-200 pb-16 pt-24 lg:pt-32 dark:border-gray-600">
			<div className="relative mx-10vw">
				<div className="relative mx-auto grid max-w-7xl grid-cols-4 gap-x-4 gap-y-8 md:grid-cols-6 lg:grid-cols-12 lg:gap-x-6">
					...
					<div className="col-span-full mt-24 text-lg text-gray-600 dark:text-gray-700">
						<Image src="/h_logo.png" alt="h_logo" className="w-full" />
						{/*<p>Консультант в области охраны психического здоровья</p>*/}
						<p>
							Индивидуальный предприниматель Гринь Валерий Валерьевич, УНП
							192617833. Консультирование по вопросам адаптации и семейных отношений.
						</p>
						<p>
							Адрес: 220006, Республика Беларусь, г. Минск, ул. Белорусская 10-1
						</p>
						<p>
							Cвидетельство гос. регистрации 192617833 от 11.03.2016 г. Выдано
							Минским горисполкомом
						</p>
						<Link
							className="text-blue-500 font-semibold py-3 hover:underline"
							href="./dogovor.pdf"
							target="_blank"
						>
